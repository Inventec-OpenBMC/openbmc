...
OBMC_IMAGE_EXTRA_INSTALL_append += " smbios-mdr smbios-mdr-reload"
...
OBMC_IMAGE_EXTRA_INSTALL_append += "phosphor-led-manager"
OBMC_IMAGE_EXTRA_INSTALL_append += "acpi-power-state-daemon"
