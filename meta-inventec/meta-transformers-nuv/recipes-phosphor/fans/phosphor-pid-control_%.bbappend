...
SRC_URI_append_transformers-nuv = " file://config-buv-nuvoton.json"
...
FILES_${PN}_append_transformers-nuv = " ${bindir}/fan-default-speed.sh"
FILES_${PN}_append_transformers-nuv = " \
    ${@entity_enabled(d, '', '${datadir}/swampd/config.json')}"

RDEPENDS_${PN} += "bash"

SYSTEMD_SERVICE_${PN}_append_transformers-nuv = " fan-reboot-control.service"
SYSTEMD_SERVICE_${PN}_append_transformers-nuv = " fan-boot-control.service"
...
EXTRA_OECONF_append_transformers-nuv = " \
